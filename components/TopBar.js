  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity onPress={peopleHandler} >
        <FontAwesome    name="users" size={27} color={peoplePressed ? "#04555c" : "#5c5c5c"} />
      </TouchableOpacity>
      <TouchableOpacity onPress={msgHandler}>
        <FontAwesome name="comments" size={27} color={msgPressed ? "#04555c" : "#5c5c5c"} />
      </TouchableOpacity>
      <TouchableOpacity onPress={userHandler}>
        <FontAwesome name="user" size={27} color={userPressed ? "#04555c" : "#5c5c5c"}  />
      </TouchableOpacity>
    </View>
  );
